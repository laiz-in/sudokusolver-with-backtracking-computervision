...
def reorder(myPoints):
    try:
        ...
        logging.info("recorder() is completed fro warp perspective")
        return myPointsNew
    except Exception as e:
        raise CustomException(e,sys)
        ...
        for i in contours:
            ...
            if area > 50:
                ...
                if area > max_area and len(approx) == 4:
                    biggest = approx
                    max_area = area
        logging.info("biggestcontour() is completed fro warp perspective")
    ...
    try:    
        ...
        for image in boxes:
            ...
            try:
                ...
                logging.info("prediction part is done using saved model: %f",probabilityValue)
            except Exception as e:
                logging.info("something went wrong while model.predict(img)")
                raise CustomException(e,sys)
            ## SAVE TO RESULT
            if probabilityValue > 0.8:
                ...
                result.append(0)
        logging.info("getprediction() is completed fro warp perspective")
        return result
    except Exception as e:
        raise CustomException(e,sys)
...
def displayNumbers(img,numbers,color = (0,255,0)):
    try:
        ...
        logging.info("displaynumber() is completed")
        return img
    except Exception as e:
        raise CustomException(e,sys)
...
def drawGrid(img):
    try:
        ...
        logging.info("drawing grid() is completed")
        return img
    except Exception as e:
        raise CustomException(e,sys)
